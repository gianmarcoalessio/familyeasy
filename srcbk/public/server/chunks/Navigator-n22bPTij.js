...
const Navigator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_path();
  return `<div class="flex flex-row items-center justify-between px-2 md:px-0"><div class="text-4xl font-bold text-primary" data-svelte-h="svelte-1gdf3ej">Family-easy</div> <ul class="menu bg-base-200 menu-horizontal rounded-box">${each([["/profilo", IconProfile], ["/spese", IconExpense], ["/bilancio", IconPig]], ([link, Icon]) => {
...
//# sourceMappingURL=Navigator-n22bPTij.js.map
