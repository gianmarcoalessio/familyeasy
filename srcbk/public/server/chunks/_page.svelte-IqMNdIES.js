...
import { N as Navigator, I as IconProfile } from './Navigator-nh7f6ntx.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex flex-col space-y-4 mx-24 mt-4">${validate_component(Navigator, "Navigator").$$render($$result, {}, {}, {})} <div class="text-6xl font-bold " data-svelte-h="svelte-b8eunv">Profilo</div></div> <div class="flex flex-col items-center justify-center space-y-8 mt-4"><div class="w-1/2 text-center p-4 bg-neutral-content rounded-xl" data-svelte-h="svelte-1aihfc2">Benvenuto su Family-easy, un progetto costruito per l&#39;esame di programmazione WEB 2023-2024 dell&#39;università di Trieste svolto da Gianmarco Alessio.
...
//# sourceMappingURL=_page.svelte-IqMNdIES.js.map
